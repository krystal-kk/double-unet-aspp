...
from models.models import U_Net, NestedUNet, AttU_Net, R2U_Net, DoubleUnet
from models import UTNet
...
def main():
    ...
    elif cfg.model_name == 'UTnet':
        model = UTNet(cfg.in_channel, base_chan=32, num_classes=1, reduce_size=4, block_list='1234', num_blocks=[1, 1, 1, 1], projection='interp', num_heads=[1, 1, 1, 1], attn_drop=0.1, proj_drop=0.1, bottleneck=False, maxpool=True, rel_pos=True, aux_loss=False)
    else:
