...
class DoubleUnet(nn.Module):
    def __init__(self):
        ...
        self.unet1 = UnetA(in_ch=3, out_ch=1)
        self.unet2 = UnetB(in_ch=3, out_ch=1)

    def forward(self, x):
        x, output1, encoder_features = self.unet1(x)
        output = self.unet2(x, output1, encoder_features)
        return output



############### Double Attention Unet ################
class AttentionUnetA(nn.Module):
    def __init__(self, in_ch=3, out_ch=1):
        super(AttentionUnetA, self).__init__()
...
class AttentionUnetB(nn.Module):
    def __init__(self, in_ch=3, out_ch=1):
        super(AttentionUnetB, self).__init__()
...
class DoubleAttentionUnet(nn.Module):
    def __init__(self):
        ...
        self.attentionunet1 = AttentionUnetA(in_ch=3, out_ch=1)
        self.attentionunet2 = AttentionUnetB(in_ch=3, out_ch=1)

    def forward(self, x):
        x, output1, encoder_features = self.attentionunet1(x)
        output = self.attentionunet2(x, output1, encoder_features)
        return output
...
############### Double Nested Unet ################
# Todo  not finished 
class NestedUnetA(nn.Module):
    def __init__(self, in_ch=3, out_ch=1):
        super(NestedUnetA, self).__init__()
...
class NestedUnetB(nn.Module):
    def __init__(self, in_ch=3, out_ch=1):
        super(NestedUnetB, self).__init__()
...
if __name__ == '__main__':
    # net = DoubleUnet(in_ch=3, out_ch=1)
    net = DoubleAttentionUnet()
    # net = UnetA(in_ch=3, out_ch=1)
    # print(net)
